...
import { Platform, View, StyleSheet, Text, Image } from "react-native"; //platform helps retrieve the OS of the device used
...
const AboutNavigator = () => {
  ...
  return (
    <Stack.Navigator screenOptions={screenOptions}>
      <Stack.Screen // name of stack.Screen will be the name prop by default
        name="About"
  ...
  return (
    ...
    >
      <Stack.Screen
        ...
        options={({ navigation }) => ({
          title: "Campsite Directory", // will be displayed in nav header
          headerLeft: () => (
            <Icon
              name="list"
              type="font-awesome"
